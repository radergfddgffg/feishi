...
async function onChatCompletionPromptReady(eventData) {
    try {
        ...
        if (eventData.dryRun !== true) {
            let stylePrompt = "";
            if (USER.tableBaseSetting.plotPreference) stylePrompt += `剧情偏好：${USER.tableBaseSetting.plotPreference}\n`;
            if (USER.tableBaseSetting.writingStyle) stylePrompt += `文风：${USER.tableBaseSetting.writingStyle}\n`;
            if (stylePrompt.trim() !== "") {
